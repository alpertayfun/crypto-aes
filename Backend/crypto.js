...
module.exports.encrypts = function(message,key,iv){
...
module.exports.decrypts = function(message,key,iv){

    var iv1 = CryptoJS.enc.Hex.parse(getHex(getBytes(iv)));
    var bytes  = CryptoJS.AES.decrypt(message.toString(), hash(key), {
          iv: iv1,
          mode: CryptoJS.mode.CBC,
          keySize: 256 / 32,
          padding: CryptoJS.pad.Pkcs7
